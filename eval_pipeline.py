"""
Script de avaliao do pipeline.
================================
Executa o pipeline em um dataset de (pergunta, resposta_referncia) e
calcula mtricas (coerncia L3, BLEU, ROUGE-L, opcionalmente similaridade).
"""
...
def run_eval(
    ...
    """
    Roda o pipeline em cada item do dataset e agrega mtricas.
    Retorna dict com scores mdios e por exemplo.
    """
    ...
    if not dataset:
        return {"error": "Dataset vazio ou no encontrado", "path": str(dataset_path)}
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Avaliao do pipeline L1L4")
